...
@interface SinaListViewController ()

@end

@implementation SinaListViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
       // static NSString *str=@"string";
        NSString *str = [NSString stringWithFormat:@"Cellstr"];
        sinaCell *cell=[tableView dequeueReusableCellWithIdentifier:str];
        if (!cell) {
            cell=[[sinaCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:str];
