...
#define CATDayLabelWidth  PL_WIDTH/8
...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(PL_WIDTH/2-50,18, 100, 15)];
    ...
    CGFloat xOffset = CATDayLabelWidth/8;
