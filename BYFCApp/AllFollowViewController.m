...
{
    count++;
    [[MyRequest defaultsRequest]afGetCustFollowCustID:[[NSUserDefaults standardUserDefaults]objectForKey:@"custID"] StartIndex:[NSString stringWithFormat:@"%ld",(unsigned long)count+1] PageSize:@"20" userid:[PL_USER_STORAGE objectForKey:PL_USER_NAME] userToken:[PL_USER_STORAGE objectForKey:PL_USER_TOKEN] completBack:^(id obj) {
