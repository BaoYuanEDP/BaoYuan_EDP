...
-(void)initView
{
    ...
    image2.image=[UIImage imageNamed:@"sinaLOGO33.png"];
    ...
    zuFNum.text=[NSString stringWithFormat:@"%@",[_dict objectForKey:@"HRXinTuiCount"]];
    ...
    priceNum.text=[NSString stringWithFormat:@"%@",[_dict objectForKey:@"HRJiShouCount"]];
    ...
    renzheng2.text=[NSString stringWithFormat:@"%@",[_dict objectForKey:@"HRRenZhengCount"]];
    ...
    refresh2.text=[NSString stringWithFormat:@"%@",[_dict objectForKey:@"HRRefreshCount"]];
    ...
    UILabel *miaoshu2=[[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(heng8.frame), PL_WIDTH, 30)];
