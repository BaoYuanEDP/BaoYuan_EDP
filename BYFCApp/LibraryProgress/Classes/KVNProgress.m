...
@property (weak, nonatomic) IBOutlet UIImageView *circleProgressView;
...
//	[self.circleProgressView.layer addSublayer:self.circleProgressLineLayer];
    self.circleProgressView.image=[UIImage imageNamed:@"icon-60@2x"];
...
- (void)setupStatus:(NSString *)status
{
	...
	self.statusLabel.font = [UIFont fontWithName:@"Helvetica-BoldOblique" size:16];
...
//        self.contentView.image =[UIImage imageNamed:@"外框2"];
	}
