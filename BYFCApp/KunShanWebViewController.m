...
@interface KunShanWebViewController ()

@end

@implementation KunShanWebViewController
...
-(void)initView
{
    ...
    UIImageView *image1=[[UIImageView alloc]initWithFrame:CGRectMake(CGRectGetMaxX(check.frame), 70, 1, 40)];
    ...
    image2.image=[UIImage imageNamed:@"anjuke_ks33.png"];
    ...
    UIView *view=[[UIView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(image3.frame), PL_WIDTH,40)];
    view.backgroundColor=[UIColor colorWithRed:170.0/255.0 green:170.0/255.0 blue:170.0/255.0 alpha:0.2];
    [self.view addSubview:view];
   
    UILabel *taocanbianhao=[[UILabel alloc]initWithFrame:CGRectMake(0, 10, check.frame.size.width, 20)];
    ...
    UIImageView *shu2=[[UIImageView alloc]initWithFrame:CGRectMake(CGRectGetMinX(image1.frame), 5, 1, 30)];
    ...
    UILabel *shouF=[[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(heng3.frame), PL_WIDTH/3-1, 40)];
    ...
    UIImageView *shu3=[[UIImageView alloc]initWithFrame:CGRectMake(CGRectGetMaxX(shouF.frame)+1, CGRectGetMaxY(heng3.frame), 1, 80)];
    shu3.image=[UIImage imageNamed:@"heng_hui_duan.png"];
    [self.view addSubview:shu3];
    
    UILabel *zuF=[[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(shu3.frame), CGRectGetMaxY(heng3.frame), PL_WIDTH/3-1, 40)];
    ...
    UIImageView *shu4=[[UIImageView alloc]initWithFrame:CGRectMake(CGRectGetMaxX(zuF.frame)+1, CGRectGetMaxY(heng3.frame), 1, 80)];
    shu4.image=[UIImage imageNamed:@"heng_hui_duan.png"];
    [self.view addSubview:shu4];
    UILabel *price=[[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(shu4.frame), CGRectGetMaxY(heng3.frame), PL_WIDTH/3, 40)];
    ...
    /*
     HRShowCount = 30;
     HRZuCount = 10;
     PackageID = "\U5957\U9910A";
     PackagePrice = 170;
     Remark = "--";
     SpecialTip = "";
     */
    UILabel *shouFNum=[[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(heng4.frame), PL_WIDTH/3-1, 40)];
    shouFNum.font=[UIFont systemFontOfSize:14];
    shouFNum.textAlignment=NSTextAlignmentCenter;
    shouFNum.text=[NSString stringWithFormat:@"%@",[_dict objectForKey:@"HRShowCount"]];
    [self.view addSubview:shouFNum];
    
    UILabel *zuFNum=[[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(shu3.frame), CGRectGetMaxY(heng4.frame), PL_WIDTH/3-1, 40)];
    zuFNum.font=[UIFont systemFontOfSize:14];
    zuFNum.textAlignment=NSTextAlignmentCenter;
    zuFNum.text=[NSString stringWithFormat:@"%@",[_dict objectForKey:@"HRZuCount"]];
    [self.view addSubview:zuFNum];
 
    UILabel *priceNum=[[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(shu4.frame), CGRectGetMaxY(heng4.frame), PL_WIDTH/3, 40)];
    ...
    miaoshu2.text=[NSString stringWithFormat:@"    %@",[_dict objectForKey:@"Remark"]];
